...
KeyInput.PlaceholderText = "Paste Key..."; KeyInput.BackgroundColor3 = Color3.fromRGB(25, 25, 25); KeyInput.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", KeyInput)

local KeyBtn = Instance.new("TextButton", KeyFrame)
KeyBtn.Size = UDim2.new(0, 100, 0, 30); KeyBtn.Position = UDim2.new(0.5, -50, 0, 100); KeyBtn.Text = "LOGIN"
KeyBtn.BackgroundColor3 = Color3.fromRGB(0, 120, 215); KeyBtn.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", KeyBtn)
...
local SideTitle = Instance.new("TextLabel", Sidebar); SideTitle.Size = UDim2.new(1,0,0,40); SideTitle.Text = "MAIN MENU"; SideTitle.TextColor3 = Color3.new(1,1,1); SideTitle.Font = Enum.Font.GothamBold; SideTitle.TextSize = 11; SideTitle.BackgroundTransparency = 1
...
local function createBtn(text)
    ...
    b.Size = UDim2.new(0, 240, 0, 40); b.Text = text; b.BackgroundColor3 = Color3.fromRGB(0,0,0); b.BackgroundTransparency = 0.6
    b.TextColor3 = Color3.new(1,1,1); b.Font = Enum.Font.Code; b.TextSize = 11; Instance.new("UICorner", b)
    Instance.new("UIStroke", b).Color = Color3.fromRGB(80,80,80)
    return b
end
...
local function setupESP(p)
    ...
    RunService.RenderStepped:Connect(function()
        if p.Character and p.Character:FindFirstChild("Head") and espEnabled then
            folder.Parent = ScreenGui; bgui.Adornee = p.Character.Head; nL.Text = p.DisplayName:upper(); hL.Text = math.floor(p.Character.Humanoid.Health) .. " HP"
        else folder.Parent = nil end
    end)
